...
class ImagingHandler(ContextHandler):
    ...
    def finish_request(self):
        should_store = self.context.modules.result_storage and not self.context.request.prevent_result_storage \
                       and (self.context.config.RESULT_STORAGE_STORES_UNSAFE or not self.context.request.unsafe)
